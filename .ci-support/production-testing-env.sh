...
#
export PRODUCTION_BRANCH="wall-coupling-production"   # The base production branch to be installed by emirge
export PRODUCTION_FORK="majosm"  # The fork/home of production changes (if any)
#
